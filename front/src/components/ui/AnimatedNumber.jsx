...
// Embedded styles, injected once on the client (deduped by id).
const STYLES = `
.an-root {
  --an-spring: linear(
...
// Zero-width space so an empty slot still has a line box to animate.
const ZWSP = '​'
...
function CharSlot({ char, direction, durationMs, blur }) {
...
/**
 * <AnimateNumber> - a number that transitions digit-by-digit, blurring only
 * the digits that change.
 *
 *   <AnimateNumber value={1234} />
 *   <AnimateNumber value={price} suffix=" ₸" format={{ maximumFractionDigits: 0 }} />
 */
